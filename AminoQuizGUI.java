//this code produces a GUI based amino acid quiz 
//the GUI has the a place for users to type in the answer, a place that shows how many right/wrong and the time left
//the GUO has “start quiz” and “cancel” buttons
//the time left counts down (in real-time) from 30 seconds...the quiz ends when the time left is 0 seconds.
//the quiz does not terminate on a wrong answer.. it will keep track of # right and wrong
...
public class AminoQuizGUI extends JFrame 
{
